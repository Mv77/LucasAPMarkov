...
#
# This notebooks presents simple computational tools to solve Lucas' asset-pricing model when the logarithm of the asset's dividend process follows an autoregressive process of order 1.
#
...
# - **The dividend process for the assets (trees)**: we assume that $\ln d_{t+1} = \alpha \ln d_t + \varepsilon_{t}$. We must create a dividend process specifying $\alpha$ and $\sigma_{\varepsilon}$.
